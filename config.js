...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_28eadba238bd5543869571ca3a052542aa').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '2347045505096',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,Lordkay',
